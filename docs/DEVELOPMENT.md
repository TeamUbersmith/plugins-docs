...
The system expects this method to return an array of `UbersmithSDK\Usage\Data` instances. Each Data instance will contain the resource object, the usage amount for the resource as well as an optional `details` parameter.
